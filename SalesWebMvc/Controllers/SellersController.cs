...
namespace SalesWebMvc.Controllers
{
   public class SellersController : Controller
   {
      ...
      public async Task<IActionResult> Index()                // Ação do Controller
      {
         var list = await _sellerService.FindAllAsync();     // que acessa o Model e
      ...
      public async Task<IActionResult> Delete(int? id)
      {
         ...
         var obj = await _sellerService.FindByIdAsync(id.Value);    // o ".value" é usado porque o id é opcional
         if (obj == null)
         {
