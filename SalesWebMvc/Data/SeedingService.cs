...
namespace SalesWebMvc.Data
{
   public class SeedingService
   {
      ...
      public void Seed()
      {
         ...
         Department d4 = new Department { Id = 4, Name = "Books" };     // Sintaxe alternativa; dá na mesma.
         ...
         Seller s3 = new Seller(3, "Alex Grey", "alex1@gmail.com", new DateTime(1988, 1, 15), 2200.00, d1);
         ...
         Seller s6 = new Seller(6, "Alex Pink", "alex2@gmail.com", new DateTime(1997, 3, 4), 3000.00, d2);
